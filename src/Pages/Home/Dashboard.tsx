...
const Dashboard = () => {
	...
	React.useEffect(()=>{
		...
		let _total = 0
		let icicb =( balances['icicb']?.balance || 0 )   +( balances['icicb']?.locked || 0);
		 
		Object.keys(balances).map((i, k) => {
			const value=(prices[i] || 0) * (balances[i]?.balance || 0 + balances[i]?.locked || 0);
		...
		<Layout>
			<div className="dashboard">  
				...
				<div className="row mt5 no-gutters">
					<div className="col-xl-6" style = {{order: 2}}>
					...
					<div className="col-xl-6"  style = {{order: 4}}>
						<h1 style = {{textAlign: "center", paddingBottom: 8, borderBottom: ' 1px solid rgb(71 63 63)'}}><i>Total Balance</i></h1>
						<div className="row">
							<div className="col-lg-6 col-md-12">
								<div style = {{height: 300, position: 'relative', display: 'flex', borderLeft: ' 1px solid rgb(71 63 63)', paddingLeft:'3em', justifyContent: 'center'}}>
									...
									<div style = {{color: 'grey', position: 'absolute', left: '3em', right: 0, top: 0, bottom: 0, display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
							...
							<div className="col-lg-6  col-md-12">
								{Object.keys(coins).map((i,k)=>(
									<div className="balance" onClick = {(e)=> {deposit(coins[i].chain)}} key={k} > 
